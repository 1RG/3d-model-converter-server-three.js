...
//Custom_code
try {
	var relsFileText = getStringFromAB(relsView.buffer);
} catch (e) {
...
//Custom_code
try {
	var fileText = getStringFromAB(view.buffer);
} catch (e) {
...
//Custom_code
var relsNode = relsXmlData.getElementsByTagName( 'Relationship' )[0];
//			var relsNode = relsXmlData.querySelector( 'Relationship' );
		...
		function parseMeshNode( meshNode, extensions ) {
			...
			var vertices = [];
//Custom_code
var	verticesN = meshNode.getElementsByTagName( 'vertices' )[0];
var vertexNodes = [];
if(verticesN != null){
	vertexNodes = verticesN.getElementsByTagName( 'vertex' );
}
//			var vertexNodes = meshNode.querySelectorAll( 'vertices vertex' );
			...
			var triangles = [];
//Custom_code
var	triangleN = meshNode.getElementsByTagName( 'triangles' )[0];
var triangleNodes = [];
if(triangleN != null){
	triangleNodes = triangleN.getElementsByTagName( 'triangle' );
}
...
//Custom_code
var basematerialsNode = resourcesNode.getElementsByTagName( 'basematerials' )[0];
