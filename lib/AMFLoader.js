...
//Custom_code
var currVolumeNode = getFirstElementChild(node);
//			var currVolumeNode = node.firstElementChild;
		...
		function loadMeshVertices( node ) {
			...
			var normalArray = [];
//Custom_code
var currVerticesNode = getFirstElementChild(node);
...
//Custom_code
var vNode = getFirstElementChild(currVerticesNode);
...
//			var objId = node.attributes[ 'id' ].textContent;
			...
			var currColor = null;
//Custom_code
var currObjNode = getFirstElementChild(node);
...
//Custom_code
var currMeshNode = getFirstElementChild(currObjNode);
...
//Custom_code
try {
	var children = getDocumentElementChildren(xmlData.documentElement);
} catch (e) {
